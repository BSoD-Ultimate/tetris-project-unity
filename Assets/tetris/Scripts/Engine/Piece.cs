...
namespace TetrisEngine
{
    public abstract class Piece
    {
        ...
        // when piece is fixed on field, if the last operation is rotation
        public bool isLastOperationRotation { get; protected set; }

        public Piece(Field bindingField)
        {
            isLastOperationRotation = false;
